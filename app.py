...
# --- 3. The Multi-Agent Workflow (No Changes Needed Here) ---
...
# --- 4. Main App Interface (Updated for Streaming) ---
...
if st.button("Generate Reply", type="primary"):
    if not incoming_message or not user_request:
        ...
        with st.spinner("Agent is thinking and drafting a reply..."):
            # Get the plan (prompt) from the planner
            ...
            # Display the generated reply using the streamer
